...
var commonColumns = []*plugin.Column{
	{Name: "apiVersion", Type: proto.ColumnType_STRING, Description: "API version of the entity"},
	...
	{Name: "uid", Type: proto.ColumnType_STRING, Description: "Unique identifier of the entity"},
	...
	{Name: "tags", Type: proto.ColumnType_JSON, Description: "Tags associated with the entity"},
